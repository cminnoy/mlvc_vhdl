/*****************************************************************************
* Filename:          C:\Projects\EDK_Trial_3/drivers/realmemory_example_v1_00_a/src/realmemory_example_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the realmemory_example driver
...
XStatus REALMEMORY_EXAMPLE_SelfTest(void * baseaddr_p)
{
  ...
  {
    REALMEMORY_EXAMPLE_mWriteMemory(LocalBRAM+4*Index, 0xDEADBEEF);
    Mem32Value = REALMEMORY_EXAMPLE_mReadMemory(LocalBRAM+4*Index);
