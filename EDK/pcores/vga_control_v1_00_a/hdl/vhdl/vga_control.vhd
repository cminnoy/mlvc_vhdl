------------------------------------------------------------------------------
-- vga_control.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
-- Date:              Sat Dec 12 15:15:55 2009 (by Create and Import Peripheral Wizard)
...
use vga_control_v1_00_a.user_logic;
...
architecture IMP of vga_control is
  ...
  ------------------------------------------
  constant USER_SLV_NUM_REG               : integer              := 18;
  ...
  constant USER_INTR_CAPTURE_MODE         : integer              := 3;
...
begin
  ...
  intr_IPIF_Lvl_Interrupts(3) <= '0';
	...
	------------------------------------------
	USER_LOGIC_I : entity vga_control_v1_00_a.user_logic
    generic map
    (
